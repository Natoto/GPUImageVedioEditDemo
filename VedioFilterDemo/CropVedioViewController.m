...
#import "CropVedioViewController.h"
...
@interface CropVedioViewController ()
{
    AVAsset * videoAsset;
    CADisplayLink* dlink;
...
@implementation CropVedioViewController
...
-(void)cropImage{
    NSURL *videoPath = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"Square" ofType:@"mp4"]];
    [self saveVideoPath:videoPath withStartTime:0.1 withEndTime:0 withSize:CGSizeMake(400, 200) withVideoDealPoint:CGPointMake(0, 0) WithFileName:@"cropVideo" shouldScale:YES];
}
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            if (UIVideoAtPathIsCompatibleWithSavedPhotosAlbum(outputURL.path)) {
                ...
                if (error) {
                    ...
                    ctr.videoPath = outputURL.relativePath;
